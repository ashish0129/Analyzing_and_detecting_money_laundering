...
String cardsql="SELECT * FROM buyerbankaccount where buyer='"+buyer+"' and site='"+sname+"'";
Statement cardst = connection.createStatement();
ResultSet cardrs =cardst.executeQuery(cardsql);
if(cardrs.next()==true)
{

		a_no=cardrs.getString(1);
		 bal=cardrs.getInt(8);
						...
						/* Updating the Balance into Bank Account */
							...
							String avbal="UPDATE buyerbankaccount SET amount="+avl_bal+" where buyer='"+buyer+"' and site='"+sname+"'";
			   ...
			   String querymini ="insert into ministatement (buyer,t_amount,t_purpose,date) values ('"+buyer+"','"+price+"','"+"Purchase"+"','"+date+"')";
			   stmini.executeUpdate (querymini);
						...
						/* Updation Query Ends */
								...
								String query11 ="insert into purchase (buyer,p_name,p_category,price,date,site,status,social_site,request_mode) values ('"+buyer+"','"+p_Name+"','"+p_Category+"','"+price+"','"+date+"','"+site+"','"+status+"','"+sname+"','"+N+"')";	   
				st11.executeUpdate (query11);
					   
					   
								Statement st1 = connection.createStatement();
								String query1 ="insert into purchase_request (buyer,p_name,p_category,price,date,site,status,social_site,request_mode) values ('"+buyer+"','"+p_Name+"','"+p_Category+"','"+price+"','"+date+"','"+site+"','"+status+"','"+sname+"','"+N+"')";	   
									...
									<div align="center"><br/>
									<br/>
									<a href="B_SearchProducts.jsp">Back</a>
									<%
									}
									else
									{
	...
	Statement mnst = connection.createStatement();
	String mnquery ="insert into money_laundering (buyer,ac_no,p_name,p_category,price,date,site,status,social_site) values ('"+buyer+"','"+a_no+"','"+p_Name+"','"+p_Category+"','"+price+"','"+date+"','"+site+"','"+"Transaction Failed"+"','"+sname+"')";	   
	mnst.executeUpdate (mnquery);									
						
						%>
						</div>
						<br/><br/> <p align="center" class="style7 style5">Insufficient Fund in Bank Account ..Please try Again..</p>
						<div align="center"><br/>
						<br/>
						<a href="BuyerMain.jsp">Back</a>
						<%
...
<br/><br/> <p align="center" class="style7 style5">Account Not Found..Please Try Again..</p>
<div align="center"><br/>
<br/>
<a href="BuyerMain.jsp">Back</a>
<%
