...
<head>
<title>Buyer Product Details Page</title>
...
%>
				  ...
				  <h3 align="right">&nbsp;</h3>
			<% 
			if(type.equalsIgnoreCase("Buyer_PurchasedProducts")){%>
            <h2 align="right"><a href="B_ViewAllPurchasedProducts.jsp" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("Buyer_Product")){%>
            <h2 align="right"><a href="BuyerMain.jsp" class="style4">Back</a></h2>
			<%}
