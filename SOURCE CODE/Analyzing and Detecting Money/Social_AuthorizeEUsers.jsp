...
<div class="main">
  ...
  <div class="content style2">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Authorize Ecommerce Users..</h2>
		  ...
		  <table width="650" border="1" align="left"  cellpadding="0" cellspacing="0"  ">
                    <tr>
					  ...
					  <td  width="84"  valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style57 style56 style5"><b>Ecommerce Website</b></div></td>
                    ...
                    <%
						...
						try 
						{
						   	String query="select * from esite"; 
                    ...
                    <tr>
                      ...
                      <td valign="middle" height="0" style="color:#000000;"align="center"><div align="center" class="style22 style5 style20 style30 style37">
                          <div align="center" class="style2"><a href="Social_UserStatus.jsp?type=<%="euser"%>&id=<%=i%>" class="style5">waiting</a></div>
                      </div></td>
                      <%
						}
						else
