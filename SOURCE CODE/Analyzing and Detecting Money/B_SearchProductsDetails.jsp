			...
			%>
			      <table width="650" border="1" align="left" cellpadding="0" cellspacing="0" >
                    ...
                    <tr >
                      ...
                      <td><br/>
					  <form method="post" action="B_PurchaseRequest.jsp"><label>
					...
					<%}%>
					 <tr>
                       <td height="57"><div align="left " class="style15 style11" style="margin-left:20px;">
                           <div align="center" class="style87 style10 style5"><b>Post Your Review</b> </div>
                       </div></td>
					   <td colspan="2"><form id="form1" method="post" action="Buyer_SubmitReview.jsp">
...
%>
				   ...
				   <div align="left">
				     ...
				     <p><a href="B_SearchProducts.jsp" class="style11 style16"><b>Back</b></a></p>
	        </div>
