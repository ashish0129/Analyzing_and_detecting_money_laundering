...
<head>
<title>Deposit Money Status Page</title>
...
<div class="main">
  ...
  <div class="content style2">
    ...
    try{
			...
			String sql="SELECT * FROM buyerbankaccount where buyer='"+buyer+"' and acc_no='"+accno+"' ";
			...
			if(rs.next()==true)
			{
			   ...
			   String query1 ="insert into ministatement (buyer,t_amount,t_purpose,date) values ('"+buyer+"','"+amount+"','"+"Deposit"+"','"+date+"')";
			   st1.executeUpdate (query1);
				
				
				String sql1="update buyerbankaccount set amount='"+amt+"' where acc_no='"+accno+"' ";
...
<br/>
  <br/>
  <a href="B_ManageAccount.jsp">Back</a>
  <%
