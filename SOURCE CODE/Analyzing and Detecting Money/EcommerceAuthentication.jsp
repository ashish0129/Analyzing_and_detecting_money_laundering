...
<div class="main">
  ...
  <div class="content style2">
      ...
      <div class="mainbar">
        <div class="article">
		  ...
		  <p>&nbsp;</p>
			...
			String eusername=request.getParameter("euname");      
	...
	try {
			...
			String sql="SELECT * FROM esite where (username='"+eusername+"' and password='"+Password+"') and site='"+esite+"'";
			Statement stmt = connection.createStatement();
			ResultSet rs =stmt.executeQuery(sql);
			if(rs.next())
			{
			
					String sql1="SELECT * FROM esite where username='"+eusername+"' and status='Authorized'";
