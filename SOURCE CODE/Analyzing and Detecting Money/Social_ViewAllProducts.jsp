	...
	<td><div align="center" style="color:#000000"><%=s4%></div></td>
	 ...
	 <td><div align="center" style="color:#000000"><%=s7%></div></td>
			   ...
			   <td><div align="center" style="color:#000000"><%=r%></div></td>
		  	   <td><div align="center"><a href="Social_Reviews.jsp?p_Name=<%= s2%>&amp;p_Category=<%=s1%>&amp;site=<%=s10%>" class="style5 style13">Reviews</a></div></td>
  </tr>
...
%>
		          ...
		          <p>&nbsp;</p>
		          <p><a href="SocialMain.jsp" class="style16">Back</a></p>
