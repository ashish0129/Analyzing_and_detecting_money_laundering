...
<head>
<title>Ecommerce Product Details Page</title>
...
%>
				  ...
				  <h3 align="right">&nbsp;</h3>
			<% 
			if(type.equalsIgnoreCase("Ecommerce_PurchaseRequest")){%>
            <h2 align="right"><a href="Ecommerce_ViewPurchaseRequest.jsp" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("Ecommerce_PurchasedProducts")){%>
            <h2 align="right"><a href="Ecommerce_ViewAllPurchasedProducts.jsp" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("Ecommerce_MoneyLaundering")){%>
            <h2 align="right"><a href="Ecommerce_ViewAllMoneyLaundering.jsp" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("Ecommerce_Exploit")){%>
            <h2 align="right"><a href="Ecommerce_ViewAllExploitVulnerability.jsp" class="style4">Back</a></h2>
			<%}
