    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  <iframe width="500" height="350" src="Social_PhishingAttacksInChart1.jsp"></iframe>
		  							<br/> 
		  							<br/>
									
							<span class="style6">( All Product Names with Number of Attacks )</span>
							
							
			                <p>&nbsp;</p>
			<div align="left" class="95"><a href="Social_ViewAllPhishingAttackers.jsp" class="style11 style17">Back</a></div>
