		  ...
		  <p>&nbsp;</p>
            <form id="form1" name="form1" method="post" action="SocialAuthentication.jsp">
					...
					<table width="464" border="0" cellspacing="2" cellpadding="2">
						<tr>
                        <td width="149" height="33"><div align="justify"><span class="style8 style38 style5 style4">Select Social Network </span></div></td>
                        <td width="274"><label>
                      ...
                      <tr>
                        <td width="197" height="46" align="justify"><span class="style34">
                          <label for="name"><span class="style4">Name (required)</span></label>
                        </span> </td>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="SocialLogin.jsp">Social Network </a></li>
