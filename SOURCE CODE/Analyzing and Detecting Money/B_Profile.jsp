...
<div class="main">
  ...
  <div class="content style2">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><%=(String)application.getAttribute("bname") %>'s Profile..</h2>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><a href="B_ManageAccount.jsp">Manage account</a></li>
			<li><a href="B_Profile.jsp">View Your Profile</a></li>
			<li><a href="B_SearchFriends.jsp">Search Friends</a></li>
			<li><a href="B_ViewFriendRequest.jsp"> View Friend Request and Response</a></li>
			<li><a href="B_MyFriends.jsp">View My Friends</a></li>
