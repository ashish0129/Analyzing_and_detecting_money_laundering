...
{	
			...
			String str4 = "insert into productsearch (buyer,p_name,category,keyword,dt) values('"+buyer+"','"+p_Name+"','"+p_Category+"','"+input+"','"+dt+"')";
              ...
              <tr>
                ...
                <td width="97" height="55"><div align="center">
                    <p class="style50"><a href="B_SearchProductsDetails.jsp?p_Name=<%=p_Name%>&amp;keyword=<%=l_Input%>&amp;p_Category=<%=p_Category%>&amp;rank=<%=rank%>&amp;site=<%=site%>" class="style56 style30 style15"><b>View Details</b></a></p>
                </div></td>
              </tr>
              <%	}
