        ...
        <div class="article">
          ...
          <table width="730" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                    <tr>
					  ...
					  <td  width="133" valign="middle" style="color: #2c83b0;"><div align="center" class="style13 style5"><b>Social Site</b></div></td>
                    ...
                    <%
						...
						try 
						{
							...
							String site=(String )application.getAttribute("esite");
						   	String query="select *  from money_laundering where site='"+site+"'"; 
                    ...
                    <tr>
					  ...
					  <td align="center"  valign="middle"><div align="center" class="style10">
                       <b><a href="Ecommerce_BuyerProfile.jsp?buyer=<%=s1%>&type=<%="Ecommerce_MoneyLaundering"%>&sname=<%=s2%>" style="color:#FF0033"><%out.println(s1);%></a>
                      </b></div></td>
					  ...
					  <td align="center"  valign="middle"><div align="center" class="style12">
                        <b><a href="Ecommerce_ProductDetails.jsp?p_Name=<%=s6%>&type=<%="Ecommerce_MoneyLaundering"%>" style="color:#006600"><%out.println(s6);%></a></b>
                      </div></td>
                      <td align="center"  valign="middle"><div align="center" class="style8">
