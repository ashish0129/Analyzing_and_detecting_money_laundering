...
<head>
<title>Ecommerce ReLogin Page</title>
		  ...
		  <p>&nbsp;</p>
            <form id="form1" name="form1" method="post" action="EcommerceAuthentication.jsp">
					...
					<table width="464" border="0" cellspacing="2" cellpadding="2">
						<tr>
                        <td width="170" height="33"><div align="justify"><span class="style8 style38 style5 style4">Select Ecommerce Website </span></div></td>
                        <td width="300"><label>
                      ...
                      <tr>
                        ...
                        <td width="253"><input id="name" name="euname" class="text" /></td>
                      </tr>
                      <tr>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><a href="EcommerceLogin.jsp">Ecommerce Login</a></li>
